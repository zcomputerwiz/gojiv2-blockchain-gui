...
Welcome to the goji-blockchain project!
We are happy that you are taking a look at the code for goji, a proof of space and time cryptocurrency.
...
If you want to learn more about this project, read the [wiki](https://github.com/goji-Network/goji-blockchain/wiki), or check out the [green paper](https://www.goji.net/assets/gojiGreenPaper.pdf).
...
Contact any of the team members on [Keybase](https://keybase.io/team/goji_network.public), which we use as the main communication method and you can comment on any Trello card.
