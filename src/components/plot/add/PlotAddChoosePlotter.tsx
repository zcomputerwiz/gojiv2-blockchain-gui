...
import { CardStep, Select } from '@goji/core';
import {
  FormControl,
  FormHelperText,
  Grid,
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default goji Proof of Space plotter. If unsure,
            use the default goji Proof of Space plotter.
        </Trans>
      </Typography>
