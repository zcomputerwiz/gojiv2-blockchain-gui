...
import { goji_to_moji, colouredcoin_to_moji } from '../../util/goji';
  ...
  function handleAdd() {
    ...
    const moji =
      wallets[wallet_id.value].type === COLOURED_COIN
        ? colouredcoin_to_moji(amount_input.value)
        : goji_to_moji(amount_input.value);

    const trade =
      buy_or_sell.value === 1
        ? newBuy(moji, wallet_id.value)
        : newSell(moji, wallet_id.value);
