...
import { /* moji_to_goji_string, */ goji_to_moji } from '../../../util/goji';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {moji_to_goji_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of goji in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of goji that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and goji that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send goji to coloured address. Please enter a goji
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'goji_addr://') {
    ...
    const amountValue = Number.parseFloat(goji_to_moji(amount));
    const feeValue = Number.parseFloat(goji_to_moji(fee));
