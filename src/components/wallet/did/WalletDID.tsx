...
import { AlertDialog, Card, Flex, Loading, Dropzone } from '@goji/core';
import {
...
import { moji_to_goji_string } from '../../../util/goji';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {moji_to_goji_string(props.balance)} TXGJ
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CreateAttest = (props) => {
  ...
  function createAttestPacket() {
    ...
    if (address.substring(0, 12) === 'goji_addr://') {
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'goji_addr://') {
